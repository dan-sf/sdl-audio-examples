...
// Play a square wav using SDL's callback function
...
int main(int argc, char* argv[]){
    ...
    for (int sample_index = 0; sample_index < sample_count; sample_index++) {
        Sint16 sample_value = ((sample_index / half_square_wave_period) % 2) ? tone_volume : -tone_volume;
    ...
    audio_data.bytes_per_period = square_wave_period * bytes_per_sample;
